...
config_dataset = 'config_prod'
config_table = 'account_assets_prod'
config_info_table = 'prod_account_asset_info'
table_suffix = '_anomaly_prod'
function_name = 'ppt_alerts'
log_table = 'prod_execution_log'
...
primary_email = 'srikar.kolli@sarasanalytics.com,santosh.nanduru@sarasanalytics.com,saikiran.kallem@sarasanalytics.com,' \
                'sumaya.bai@sarasanalytics.com,sai.harshith@sarasanalytics.com'
...
dict_email_config = {'Levis SG': Email(asset_name="Levis Singapore",
                                       primary_email='itan@levi.com,wfoong@levi.com,chauville@levi.com,kong@levi.com,'
                                                     'skhor@levi.com,pchan1@levi.com,kcostas@levi.com,jlim3@levi.com,'
                                                     'santosh.nanduru@sarasanalytics.com,sumaya.bai@sarasanalytics.com,'
                                                     'saikiran.kallem@sarasanalytics.com,pchatterjee@levi.com,'
                                                     'lbhansali@levi.com,'
                                                     'likitha.kakanuru@sarasanalytics.com',
                                       cc="",
                                       client_timezone='Asia/Singapore'),
                     'Levis Malaysia': Email(asset_name="Levis Malaysia",
                                             primary_email='itan@levi.com,wfoong@levi.com,chauville@levi.com,'
                                                           'kong@levi.com,jlim3@levi.com,pchatterjee@levi.com,'
                                                           'skhor@levi.com,pchan1@levi.com,kcostas@levi.com,'
                                                           'santosh.nanduru@sarasanalytics.com,'
                                                           'sumaya.bai@sarasanalytics.com,'
                                                           'saikiran.kallem@sarasanalytics.com,'
                                                           'likitha.kakanuru@sarasanalytics.com',
                                             cc="",
                                             client_timezone='Asia/Jakarta'),
                     'Levis Indonesia': Email(asset_name="Levis Indonesia",
                                              primary_email="Srahadi@levi.com,sbey@levi.com,aidris@levi.com,"
                                                            "darundina@levi.com,mlestari@levi.com,pchan1@levi.com,"
                                                            "kcostas@levi.com,chauville@levi.com,wfoong@levi.com,"
                                                            "jlim3@levi.com,santosh.nanduru@sarasanalytics.com,"
                                                            "sumaya.bai@sarasanalytics.com,pchatterjee@levi.com,"
                                                            "saikiran.kallem@sarasanalytics.com,"
                                                            "hprasetyo@levi.com,nputri@levi.com,"
                                                            "likitha.kakanuru@sarasanalytics.com",
                                              cc="",
                                              client_timezone=''),
                     'Levis Philippines': Email(asset_name="Levis Philippines",
                                                primary_email="rviernes@levi.com,mventura1@levi.com,pchan1@levi.com,"
                                                              "kcostas@levi.com,chauville@levi.com,wfoong@levi.com,"
                                                              "jlim3@levi.com,santosh.nanduru@sarasanalytics.com,"
                                                              "sumaya.bai@sarasanalytics.com,pchatterjee@levi.com,"
                                                              "saikiran.kallem@sarasanalytics.com,adelrosario@levi.com,"
                                                              "likitha.kakanuru@sarasanalytics.com",
                                                cc="",
                                                client_timezone='Asia/Manila'),
                     'Levis AUS_NZ': Email(asset_name="Levis Australia & New Zealand",
                                           primary_email="cschneider@levi.com,jrobins@levi.com,fdupont@levi.com,"
                                                         "yagnesh@sarasanalytics.com,pchatterjee@levi.com,"
                                                         "abhijeet@sarasanalytics.com,"
                                                         "santosh.nanduru@sarasanalytics.com,"
                                                         "sumaya.bai@sarasanalytics.com,"
                                                         "likitha.kakanuru@sarasanalytics.com,"
                                                         "chauville@levi.com,mohith.das@sarasanalytics.com,"
                                                         "srikar.kolli@sarasanalytics.com,"
                                                         "saikiran.kallem@sarasanalytics.com",
                                           cc="",
                                           client_timezone='Australia/Canberra'),
                     'Levis Korea': Email(asset_name="Levis Korea",
                                          primary_email="eyang1@levi.com,pchatterjee@levi.com,chauville@levi.com,"
                                                        "yagnesh@sarasanalytics.com,abhijeet@sarasanalytics.com,"
                                                        "santosh.nanduru@sarasanalytics.com,"
                                                        "likitha.kakanuru@sarasanalytics.com,"
                                                        "sumaya.bai@sarasanalytics.com,mohith.das@sarasanalytics.com,"
                                                        "slee12@levi.com,"
                                                        "srikar.kolli@sarasanalytics.com,"
                                                        "saikiran.kallem@sarasanalytics.com",
                                          cc="",
                     ...
                     'Levis JP': Email(asset_name="Levis Japan",
                                       primary_email="tyamamoto@levi.com,myoshizawa@levi.com,rsatake@levi.com,"
                                                     "hasano1@levi.com,kkansha@levi.com,pchatterjee@levi.com,"
                                                     "yagnesh@sarasanalytics.com,abhijeet@sarasanalytics.com,"
                                                     "likitha.kakanuru@sarasanalytics.com,chauville@levi.com,"
                                                     "santosh.nanduru@sarasanalytics.com,sumaya.bai@sarasanalytics.com,"
                                                     "mohith.das@sarasanalytics.com,srikar.kolli@sarasanalytics.com,"
                                                     "saikiran.kallem@sarasanalytics.com",
                                       cc="",
